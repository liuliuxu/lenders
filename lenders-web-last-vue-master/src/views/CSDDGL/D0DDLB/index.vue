...
<!-- 		      <el-button
		...
		<el-dialog :title="BackShow? $t('table.fetchBackLink'): $t('table.fetchRenewkLink')" :visible.sync="fetchbackPaymentLinkModalShow" direction="rtl" width="40%">
		  ...
		  return {
				...
				formRemarks: {
			  	...
			  	rulesRemarks: {
					...
					IsRegister: [
						{ required: true, message: 'Please select Is called', trigger: 'change' }
					],
					IsConnected: [
      ...
      this.fetchGetCollectionTags();
		...
		methods: {
			...
			fetchData() {
				...
				D0CollectionList(this.listQuery).then(response => {
