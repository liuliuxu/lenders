...
import { CollectionNewList, GetCollectionManList, D3AllotCollection, SendRepaymentLoans, SetCollRemark, SearchCollRemark,CollectionMobileClick } from '@/api/user';
...
const _tableConfig=[
  ...
  {key:'DeductionAmount',name:'DeductionAmount'},
