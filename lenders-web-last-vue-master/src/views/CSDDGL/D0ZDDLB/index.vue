...
<script>
  ...
  import { D0CollectionTotalList, GetCollectionManList, D0AllotCollection, SendRepaymentLoans, SetCollRemark, SearchCollRemark,CollectionMobileClick } from '@/api/user';
      ...
      closeDetails() {
        ...
        this.setTagOpt();
			...
			fetchData() {
				...
				D0CollectionTotalList(this.listQuery).then(response => {
