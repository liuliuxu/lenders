...
<script>
  ...
  import BorrowingInfo from '@/components/BorrowingInfo';
	import { CollectionTotalList, GetCollectionManList, AllotCollection, SendRepaymentLoans, SetCollRemark, SearchCollRemark,CollectionMobileClick } from '@/api/user';
      ...
      closeDetails() {
        ...
        this.setTagOpt();
		  ...
		  fetchData() {
			...
			CollectionTotalList(this.listQuery).then(response => {
