...
<script>
	...
	const tableConfig=[
		{key:'ID',name:'主键ID'},
		{key:'ChannelName',name:'渠道商名'},
		{key:'ChannleNo',name:'渠道号'},
		{key:'AddTime',name:'添加时间'}
	]
	const formConfig=[
		[{key:'ChannelName',name:'渠道商名',type:'input',disabled:false,rules:[{ required: true, message: '渠道商名不能为空'}]}],
		[{key:'ChannleNo',name:'渠道号',type:'input',disabled:false,rules:[{ required: true, message: '渠道号不能为空'}]}],
	]
	//新增英文
	const _searchConfig=[
