...
<script>
    ...
    const tableConfig=[
        ...
        {key:'Name',name:'姓名'},
        {key:'Mobile',name:'手机号'},
        {key:'RenewDate',name:'展期时间'},
        {key:'NextShouldRepaymentDate',name:'下次应还时间'},
        {key:'RenewMoney',name:'展期金额'},
    ];

    // 获取还款记录报表配置en
    const _tableConfig=[
        {key:'OrderId',name:'OrderId', nameCn: '订单号'},
        {key:'Name',name:'Name', nameCn: '姓名'},
        {key:'Mobile',name:'Mobile', nameCn: '手机号'},
        {key:'RenewDate',name:'RenewDate', nameCn: '展期时间'},
        {key:'NextShouldRepaymentDate',name:'NextShouldRepaymentDate', nameCn: '下次应还时间'},
        {key:'RenewMoney',name:'RenewMoney', nameCn: '展期金额'},
    ];
