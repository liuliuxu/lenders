...
const searchConfig = [
	...
	{ key: 'CardId', name: 'PAN 卡', type: 'input', value: '' }
]
const tableConfig = [
	{ key: 'ID', name: '用户ID', width: '120' },
	{ key: 'Mobile', name: '手机号', width: '150' },
	{ key: 'CardID', name: 'PAN 卡' },
	{ key: 'Addtime', name: '申请时间', width: '150' },
	{ key: 'IsRegister_Ch', name: '是否注册' },
	{ key: 'IsCallPhone_Ch', name: '是否打电话' },
	{ key: 'Remark', name: '备注' }
]
const formConfig = [
	[{ key: 'ID', name: '用户ID', type: 'input', disabled: true }, { key: 'Mobile', name: '手机号', type: 'input', disabled: true }],
	[{ key: 'CardID', name: 'pan卡号', type: 'input', disabled: true }, { key: 'Addtime', name: '申请时间', type: 'input', disabled: true }],
