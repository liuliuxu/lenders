...
import { GetF1CollectionReportInfo } from '@/api/report';
...
export default {
  ...
  methods: {
    ...
    setZDDtype() {
      if (this.$route.path === '/DF1YJBB') {
        this.listCSRYQuery.type = 'D-1';
        this.viewPageType = 'D-1';
      }
    },
    fetchCSRYData() {
    ...
    fetchData() {
      ...
      GetF1CollectionReportInfo(this.listQuery).then(response => {
